...
@XmlRootElement(name = "SPSVerification")
public class SPSVerification {

    @XmlElementRef(name = "UID_NUM", namespace = "http://Testing/xsd", type = JAXBElement.class, required = false)
